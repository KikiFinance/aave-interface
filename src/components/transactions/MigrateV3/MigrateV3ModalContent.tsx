...
export const MigrateV3ModalContent = ({
  ...
  const handleRoute = (market: CustomMarket) => {
    if (market === CustomMarket.proto_exsat_test2_v3) {
    ...
    // } else {
      setCurrentMarket('proto_exsat_test2_v3' as CustomMarket);
      router.push(`/?marketName=${CustomMarket.proto_exsat_test2_v3}`);
    }
  };
